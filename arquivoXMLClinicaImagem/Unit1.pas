...
///////////////////////////////////////////////////////////
      ...
      if (Copy(Trim(vArquivo.Strings[i]), 1, 19) = '<ans:valorLiberado>') then
      begin
      ...
      //valor informado da guia
      if (Copy(Trim(vArquivo.Strings[i]), 1, 23) = '<ans:valorLiberadoGuia>') then
      begin
      ...
      //valor informado do protocolo
      if (Copy(Trim(vArquivo.Strings[i]), 1, 28) = '<ans:valorLiberadoProtocolo>') then
      begin
      ...
      //valor informado do arquivo
      if (Copy(Trim(vArquivo.Strings[i]), 1, 24) = '<ans:valorLiberadoGeral>') then
      begin

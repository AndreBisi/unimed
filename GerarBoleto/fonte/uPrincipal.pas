...
begin
  ...
  begin
    ...
    MessageBox(Application.Handle, PChar( 'O arquivo não existe' ), 'Erro', 16 );
  end
  else
        ...
        try
          ...
          begin
            ...
            try
              ...
              IdMessage2.From.Name              := 'Unimed de Tupã Cooperativa de Trabalho Médico';
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              gravaDados( i, 'Após o cumprimento do Comunicado nº 85 de 31 de agosto de 2020 da ANS sobre suspensão da aplicação do reajuste do plano ', vPagina );
              Inc( i );
              gravaDados( i, 'de saúde por variação de custos (anual) no período de setembro a dezembro de 2020, segue recomposição dos valores.      ', vPagina );
              Inc( i );
              gravaDados( i, 'Conforme Diretoria Colegiada (DICOL) da ANS definiu que, os valores relativos a suspensão do reajuste no  período  será ', vPagina );
              Inc( i );
              gravaDados( i, 'diluído em 12 parcelas iguais e sucessivas (janeiro a dezembro/2021).                                                   ', vPagina );
              Inc( i );
...
begin
  ...
  begin
    ...
    CopyFile( Pchar( ArqEnv[ i - 1 ] ),
              Pchar( 'C:\EnvioProdução\Enviados\' + Arquivo ), FALSE );

...
begin
  ...
  begin
    ...
    begin
      qryPessoa.Close;
      qryPessoa.ParamByName('codPessoa').AsInteger := qryProcessoCOD_PESSOA.AsInteger;
      qryPessoa.Open();
      ...
      RenameFile(edtDiretorio1.Text + '\' + lbArquivo.Items[ i ],
                 edtDiretorio1.Text + '\' + FormatFloat('00000000', qryProcessoCOD_PESSOA.AsInteger ) +
                 'MENSALIDADE' + formatfloat('0000', i) + '.PDF');
      qryProcesso.Next;
    end;
  end;
end;
